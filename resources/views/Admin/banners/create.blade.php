...
<div class="col-md-8 center-block" id="class-create">
  <div>
    ...
    <div class="card mb-4" >
            ...
            <div class="modal-dialog modal-fullscreen" role="document">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  ...
                  <button type="submit" class="btn btn-primary" form="classForm">Thêm</button>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="card-body">
        <form action="/admin/banners/store" method="POST" id="classForm" enctype="multipart/form-data">
          @csrf
        <div>
