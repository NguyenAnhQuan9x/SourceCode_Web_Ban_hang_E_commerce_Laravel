                                        ...
                                        <div class="product">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <h3 class="product-name"><a
                                                        href="{{ route('client.product', $item->id) }}">{{ $item->title }}</a>
                                                </h3>
                                                <h4 class="product-price">{{ number_format($item->price, 0, '', '.') }} đ <del
                                            ...
                                            <div class="add-to-cart">
                                                <button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i><a
                                                        href="{{ route('client.addToCart', $item->id) }}">add to
                                                        cart</a></button>
                                            </div>
                                        </div>
                                    @endforeach
								...
								<div id="tab2" class="tab-pane fade in active">
									<div class="products-slick" data-nav="#slick-nav-2">
										...
										<div class="product">
											...
											<div class="add-to-cart">
                                                <button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i><a
                                                        href="{{ route('client.addToCart', $item->products->id) }}">add to
                                                        cart</a></button>
                                            </div>
										</div>
										@endforeach
