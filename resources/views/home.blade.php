...
@section('main-content')
                        ...
                        <div class="col-lg-6 col-md-12 col-6 mb-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <span class="fw-semibold d-block mb-1">Người dùng</span>
    ...
    <div class="card">
        <h5 class="card-header text-primary">Top 10 sản phẩm bán chạy nhất</h5>
        <div class="table-responsive text-nowrap">
          <table class="table">
            ...
            <tbody>
              @foreach ($Top10ProductBestSellers as $index=>$item)
                  <tr>
                    <td>{{ $index }}</td>
